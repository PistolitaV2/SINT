...
public class Movie implements Comparable<Movie> {
    ...
    public Movie(String titulo, ArrayList<String> genre, String duracion, String langs,String sinopsis,String año)  {
        this.titulo = titulo;
        this.genre = genre;
    ...
    public String toStringHTMLQ2() {

        String cadena = "Película=" + this.titulo + "("+this.año+") --- Géneros='"+this.genre+"'---Sinopsis:'" + this.sinopsis
        + "'";
        return cadena;
    }
